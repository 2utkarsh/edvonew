export const DEFAULT_HOME_CONTENT = {
  ...
  hiringPartnersSection: {
    ...
    buttonHref: '/testimonials/success-stories',
  },
  hiringPartners: [
    { name: 'INTEG', logo: '/images/partners/integ.png', showOnHome: true },
    { name: 'IQVIA', logo: '/images/partners/iqvia.png', showOnHome: true },
    { name: 'Numerator', logo: '/images/partners/numerator.png', showOnHome: true },
    { name: 'OLA ELECTRIC', logo: '/images/partners/ola.png', showOnHome: true },
    { name: 'ORACLE', logo: '/images/partners/oracle.png', showOnHome: false },
    { name: 'P&G', logo: '/images/partners/pg.png', showOnHome: false },
    { name: 'SBFC', logo: '/images/partners/sbfc.png', showOnHome: false },
    { name: 'TCS', logo: '/images/partners/tcs.png', showOnHome: false },
    { name: 'THE MEDIA ANT', logo: '/images/partners/media-ant.png', showOnHome: false },
  ],
  testimonialsIntro: {
