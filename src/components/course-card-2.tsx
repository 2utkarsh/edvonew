                     ...
                     <Tooltip>
                        <TooltipTrigger className="absolute top-2 right-2 z-10">
                           <Button
                              size="icon"
                              variant="ghost"
                              className="bg-background/85 shadow-sm backdrop-blur hover:bg-background dark:bg-slate-900/85 dark:hover:bg-slate-900"
            ...
            <CardContent className="p-0 pb-5">
               <div className="mb-6 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                     {course.discount ? (
                        <p className="pt-1 text-muted-foreground line-through">
                           {currency?.symbol}
