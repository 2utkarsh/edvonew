            ...
            <Card key={course.id} className="overflow-hidden group cursor-pointer hover:shadow-lg transition-all">
              <div className="relative aspect-video bg-gradient-to-br from-slate-800 to-slate-900">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center text-white">
                    ...
                    <div className="text-xs opacity-80">Course Image</div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-lg font-bold text-slate-950 dark:text-white">₹{course.price.toLocaleString()}</span>
...
// Pre-configured sections for each category
export const DataAnalyticsSection = () => {
  const courses = [
    ...
    {
      id: 5,
      title: 'AI Automation for Data Professionals',
      rating: 5.0,
      reviews: 61,
      enrolled: '182',
      price: 1800,
  ...
  return (
    <CourseCategorySection
      ...
      subtitle="Master the tools and thinking behind every data-driven decision"
      courses={courses}
      bgColor="bg-background dark:bg-slate-900"
    />
  );
};
...
export const AIDataScienceSection = () => {
  const courses = [
    ...
    {
      id: 2,
      title: 'Master Machine Learning for Data Science & AI: Beginner to Advanced',
      rating: 5.0,
      reviews: 234,
      enrolled: '4,129',
      price: 1800,
    ...
    },
    {
      ...
      enrolled: '2,078',
      price: 900,
      image: '/images/courses/math-stats.jpg',
    },
  ];
  ...
  return (
    <CourseCategorySection
      ...
      subtitle="Understand the science behind AI and learn to build real-world models, one concept at a time"
      courses={courses}
...
export const ProfessionalSkillsSection = () => {
  const courses = [
    {
      id: 1,
      title: 'AI Toolkit For Professionals',
      rating: 5.0,
      reviews: 61,
      enrolled: '2,249',
      price: 1800,
      image: '/images/courses/ai-toolkit.jpg',
    },
    {
      id: 2,
      title: 'Mastering Communication & Stakeholder Management',
      rating: 5.0,
      reviews: 718,
      enrolled: '718',
      price: 600,
    ...
    {
      id: 3,
      title: 'Mastering Time Management & Deep Work',
      rating: 5.0,
      reviews: 380,
      enrolled: '380',
      price: 900,
      badge: 'Brand New',
      image: '/images/courses/time-management.jpg',
    },
    {
      id: 4,
      title: 'Personal Branding (LinkedIn & Beyond) for All Professionals',
      rating: 5.0,
      reviews: 44,
      enrolled: '44',
      price: 900,
      badge: 'Brand New',
      image: '/images/courses/personal-branding.jpg',
    },
  ];

  return (
    <CourseCategorySection
      title="Professional Upskilling Courses"
      subtitle="Sharpen the timeless skills that set great professionals apart"
      courses={courses}
      bgColor="bg-background dark:bg-slate-900"
    />
  );
