...
const Navbar = ({ language = false, heightCover = true, customizable = true }: NavbarProps) => {
   ...
   return (
      <>
        <div 
  className={cn(
    'fixed z-30 w-full transition-all duration-500 ease-in-out',
    // Logic: If sticky, move to bottom. If not sticky (or menu is open), stay at top.
    isSticky  ? 'bottom-6 top-auto' : 'top-0',
            ...
            >
               <div className="flex items-center gap-2">
                  ...
                  <Link href="/" className="flex items-center gap-3">
                     <AppLogo />
                     <span className="text-primary hidden text-sm font-medium md:block">
                        India's Faster Growing Learning Platform
                     </span>
                  </Link>
               </div>
