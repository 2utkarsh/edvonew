...
import { SystemProps } from '@/app/dashboard/admin/settings/system';
...
const Index = () => {
   ...
   return (
      <div className="overflow-hidden bg-[rgba(255,222,99,0.06)]">
         {/* Stay Update with EDVO Section */}
         <div className="container py-12">
            <div className="bg-primary rounded-2xl px-6 py-8 text-center">
               <h3 className="text-2xl font-bold text-white">Stay Update with EDVO</h3>
               <p className="text-white/90 mt-2 text-sm">
                  Subscribe to get the latest updates and news about EDVO platform
               </p>
            </div>
         </div>
