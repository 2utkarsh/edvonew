...
const testimonials = [
  ...
  {
    quote: "As a hiring manager who frequently partners with EDVO, I've been consistently impressed with the caliber of candidates. Their focus on practical, project-based learning is exactly what we need.",
    author: "Subham Singh",
  ...
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <section className="relative overflow-hidden bg-slate-900 px-4 py-24 text-white sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <FadeIn>
              <Badge variant="accent" className="mb-6 uppercase tracking-widest">For HRs & Hiring Managers</Badge>
              <h1 className="text-4xl font-black leading-tight tracking-tight sm:text-6xl">
                Hire The Best Data Professionals at <span className="text-lime-400">zero cost.</span>
              </h1>
              <p className="mt-8 text-xl leading-relaxed text-slate-300">
                Skip CV screening, interview rounds, and save 2X time by hiring vetted Data Analysts and Engineers from our talent pool.
              </p>
              <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                ...
                <div className="flex items-center gap-4 border-l border-white/20 pl-6 text-slate-400">
                  ...
                  <span className="text-sm font-medium">Trusted by 350+ Industry Leaders</span>
                </div>
              </div>
            </FadeIn>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            {testimonials.map((testimonial) => (
              <div key={testimonial.author} className="relative rounded-[2.5rem] bg-white p-10 shadow-xl dark:bg-slate-900 border border-slate-100 dark:border-slate-800">
                <Quote className="absolute right-10 top-10 h-12 w-12 text-slate-100 dark:text-white/5" />
                <p className="relative z-10 text-lg leading-relaxed text-slate-700 dark:text-slate-300 italic">
                  "{testimonial.quote}"
                </p>
                <div className="mt-10 flex items-center gap-4">
                  <img src={testimonial.image} alt={testimonial.author} className="h-12 w-12 rounded-full border-2 border-primary-100 dark:border-slate-700" />
                  <div>
      ...
      <section className="pb-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-[3rem] bg-slate-950 p-12 text-center text-white sm:p-20 relative overflow-hidden">
             <div className="absolute inset-0 bg-gradient-to-r from-primary-900/40 via-transparent to-accent-900/40" />
             <div className="relative z-10">
               <h2 className="text-3xl font-black sm:text-5xl">Ready to skip the hiring hustle?</h2>
               <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-400 leading-relaxed">
                 Partner with us today and get access to the top 1% of our vetted data talent. No hidden fees, just great talent.
               </p>
               <div className="mt-12 flex flex-col justify-center gap-4 sm:flex-row">
                 <Link href="/contact">
                   <Button variant="primary" size="lg" className="!bg-lime-300 !text-slate-950 !rounded-2xl h-14 px-10">
                     Partner With Us
                   </Button>
                 </Link>
                 <Link href="/testimonials">
                   <Button variant="outline" size="lg" className="!border-white/20 !text-white !rounded-2xl h-14 px-10 hover:!bg-white/10">
                     See Success Stories
                   </Button>
                 </Link>
               </div>
