...
const NewCourses = () => {
   ...
   return (
      <Section customize={customize} pageSection={newCoursesSection} containerClass="py-20" contentClass="relative z-10">
         ...
         <div className="after:pointer-events-none after:absolute after:-right-10 after:bottom-0 after:h-[240px] after:w-[240px] after:rounded-full after:bg-[rgba(0,167,111,1)] after:blur-[290px] after:content-['']"></div>
      </Section>
   );
};
