...
interface ForumReplyFormData {
   url: string;
   user_id: string | number;
   course_id: string | number;
   course_forum_id: string | number;
   course_forum_user_id: string | number;
   description: string;
}
...
const ForumReply = ({ url, user, forum, reply, actionComponent }: Props) => {
   ...
   const { data, setData, post, put, errors, processing, reset } = useForm<ForumReplyFormData>({
      url,
      user_id: user.id,
