...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request): array
    {
        ...
        $user = Auth::user();
        $system = app()->bound('system_settings') ? app('system_settings') : null;
        ...
        if ($system && isset($system->fields) && is_array($system->fields) && array_key_exists('direction', $system->fields)) {
        ...
        return [
            ...
            'page' => app()->bound('intro_page') ? app('intro_page') : null,
            'auth' => ['user' => $user],
            'system' => $system,
